...
_DEFAULT_ACTION_PROMPT = '(FN)(FN)(FN)(FN)(FN)(FN)(FN)(FN)(FN)(FN)(FN)(FN)(FN)(FN)(FN)(FN)(FN)(FN)(FN)(FN)'
_POPULATED_TYPES = {'single-human', 'multiple-human'}
...
if __name__ == "__main__":
    fire.Fire({'run': main, 'vbench': vbench_batch})